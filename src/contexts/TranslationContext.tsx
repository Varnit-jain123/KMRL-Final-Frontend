...
const translations = {
  ...
  'notices.empty.description': 'No notices have been posted yet',
   ...
   // Compose Form
    ...
    'history.subtitle': 'Track your downloads and read notices',
    ...
    'history.downloads.metro.expansion': 'Metro Expansion Project Report',
    'history.downloads.safety.protocol': 'Safety Protocol Guidelines',
    'history.downloads.budget.allocation': 'Budget Allocation Q4 2024',
    'history.downloads.training.manual': 'Employee Training Manual',
    'history.downloads.technical.specs': 'Technical Specifications Phase 2',
    'history.notices.system.maintenance': 'System Maintenance Schedule',
    'history.notices.safety.protocol': 'New Safety Protocol Implementation',
    'history.notices.team.meeting': 'Monthly Team Meeting',
    'history.notices.budget.review': 'Budget Review Guidelines',
    'history.notices.emergency.drill': 'Emergency Drill Schedule',
    ...
    'help.subtitle': 'Find answers, watch tutorials, and get the help you need',
    'help.quick.video.tutorials': 'Video Tutorials',
    'help.quick.video.description': 'Step-by-step guides',
    'help.quick.faq': 'FAQ',
    'help.quick.faq.description': 'Common questions',
    'help.quick.contact': 'Contact Support',
    'help.quick.contact.description': 'Get direct help',
    'help.tabs.tutorials': 'Tutorials',
    'help.tabs.faq': 'FAQ',
    'help.tabs.troubleshooting': 'Troubleshooting',
    'help.tabs.contact': 'Contact',
    'help.button.watch.tutorial': 'Watch Tutorial',
    'help.search.faq.placeholder': 'Search FAQ...',
    'help.troubleshooting.title': 'Common Issues & Solutions',
    'help.contact.info.title': 'Contact Information',
    'help.contact.email.label': 'Email Support',
    'help.contact.phone.label': 'Phone Support',
    'help.contact.chat.label': 'Live Chat',
    'help.contact.chat.hours': 'Available 9 AM - 6 PM IST',
    'help.contact.form.title': 'Submit Support Request',
    'help.contact.form.subject': 'Subject',
    'help.contact.form.subject.placeholder': 'Brief description of your issue',
    'help.contact.form.category': 'Category',
    'help.contact.form.category.general': 'General',
    'help.contact.form.category.technical': 'Technical Issue',
    'help.contact.form.category.account': 'Account & Access',
    'help.contact.form.category.ai': 'AI Features',
    'help.contact.form.urgency': 'Urgency',
    'help.contact.form.urgency.normal': 'Normal',
    'help.contact.form.urgency.high': 'High',
    'help.contact.form.urgency.urgent': 'Urgent',
    'help.contact.form.message': 'Message',
    'help.contact.form.message.placeholder': 'Describe your issue in detail...',
    'help.contact.form.submit': 'Submit Support Request',
    
    // Tutorials
    'help.tutorials.getting.started.title': 'Getting Started with KMRL Document Platform',
    'help.tutorials.getting.started.description': 'Learn the basics of uploading, organizing, and searching documents',
    'help.tutorials.ai.features.title': 'AI Features Overview',
    'help.tutorials.ai.features.description': 'Discover how AI summaries, auto-tagging, and smart reminders work',
    'help.tutorials.notifications.title': 'Setting Up Notifications and Reminders',
    'help.tutorials.notifications.description': 'Configure your notification preferences and create effective reminders',
    'help.tutorials.collaboration.title': 'Collaborating with Team Members',
    'help.tutorials.collaboration.description': 'Share documents, create notices, and work with department colleagues',
    'help.tutorials.category.getting.started': 'Getting Started',
    'help.tutorials.category.ai.features': 'AI Features',
    'help.tutorials.category.notifications': 'Notifications',
    'help.tutorials.category.collaboration': 'Collaboration',
    
    // FAQ
    'help.faq.category.general': 'General',
    'help.faq.category.ai.features': 'AI Features',
    'help.faq.category.security': 'Security',
    'help.faq.general.upload.question': 'How do I upload a document to the platform?',
    'help.faq.general.upload.answer': 'You can upload documents by clicking the \'Upload Document\' button in the dashboard or navigation panel. Supported formats include PDF, DOCX, XLSX, and images. The AI will automatically process and categorize your document.',
    'help.faq.general.formats.question': 'What file formats are supported?',
    'help.faq.general.formats.answer': 'We support PDF, Microsoft Office documents (DOCX, XLSX, PPTX), images (JPG, PNG), and text files. Maximum file size is 50MB per document.',
    'help.faq.general.ai.summary.question': 'How does the AI summarization work?',
    'help.faq.general.ai.summary.answer': 'Our AI automatically analyzes uploaded documents and creates concise summaries highlighting key points. You can also listen to audio versions of these summaries.',
    'help.faq.ai.tags.accuracy.question': 'How accurate are the AI-generated tags?',
    'help.faq.ai.tags.accuracy.answer': 'Our AI tagging system has a 90%+ accuracy rate. Tags are based on document content analysis and can be manually edited if needed.',
    'help.faq.ai.disable.question': 'Can I disable AI features?',
    'help.faq.ai.disable.answer': 'Yes, you can toggle AI features on/off in the AI Features section. This includes auto-summaries, smart tagging, and reminder suggestions.',
    'help.faq.security.data.question': 'How secure is my data?',
    'help.faq.security.data.answer': 'All documents are encrypted at rest and in transit. We follow industry-standard security practices and comply with data protection regulations.',
    'help.faq.security.access.question': 'Who can access my documents?',
    'help.faq.security.access.answer': 'Document access is controlled by role-based permissions. Only authorized team members and departments can view specific documents based on your organization\'s settings.',
    
    // Troubleshooting
    'help.troubleshooting.upload.issue': 'Documents not uploading',
    'help.troubleshooting.upload.solution.1': 'Check file size (must be under 50MB)',
    'help.troubleshooting.upload.solution.2': 'Verify file format is supported',
    'help.troubleshooting.upload.solution.3': 'Clear browser cache and cookies',
    'help.troubleshooting.upload.solution.4': 'Try uploading from a different browser',
    'help.troubleshooting.upload.solution.5': 'Contact support if issue persists',
    'help.troubleshooting.ai.issue': 'AI features not working',
    'help.troubleshooting.ai.solution.1': 'Ensure AI features are enabled in settings',
    'help.troubleshooting.ai.solution.2': 'Check document format compatibility',
    'help.troubleshooting.ai.solution.3': 'Wait for processing to complete (may take 1-2 minutes)',
    'help.troubleshooting.ai.solution.4': 'Refresh the page and try again',
    'help.troubleshooting.ai.solution.5': 'Contact technical support',
    'help.troubleshooting.access.issue': 'Cannot access certain documents',
    'help.troubleshooting.access.solution.1': 'Verify you have proper permissions',
    'help.troubleshooting.access.solution.2': 'Check if document was moved or deleted',
    'help.troubleshooting.access.solution.3': 'Contact document owner or administrator',
    'help.troubleshooting.access.solution.4': 'Ensure you\'re logged into correct account',
    'help.troubleshooting.access.solution.5': 'Review access control settings',

    // Settings Section
    'settings.title': 'Settings',
    'settings.subtitle': 'Customize your KMRL platform experience',
    'settings.tabs.preferences': 'Preferences',
    'settings.tabs.security': 'Security',
    'settings.tabs.access': 'Access Control',
    'settings.appearance.title': 'Appearance',
    'settings.appearance.dark.mode': 'Dark Mode',
    'settings.appearance.dark.mode.description': 'Switch between light and dark themes',
    'settings.appearance.compact.view': 'Compact View',
    'settings.appearance.compact.view.description': 'Show more content in less space',
    'settings.appearance.language': 'Language',
    'settings.notifications.title': 'Notifications',
    'settings.notifications.documents': 'Document uploads',
    'settings.notifications.reminders': 'Reminders',
    'settings.notifications.notices': 'Important notices',
    'settings.notifications.ai.processing': 'AI processing',
    'settings.preferences.title': 'General Preferences',
    'settings.preferences.auto.save': 'Auto-save drafts',
    'settings.preferences.auto.save.description': 'Automatically save work in progress',
    'settings.preferences.show.tips': 'Show tips',
    'settings.preferences.show.tips.description': 'Display helpful tips and guidance',
    'settings.preferences.auto.logout': 'Auto-logout (minutes)',
    'settings.data.privacy.title': 'Data & Privacy',
    'settings.data.export': 'Export My Data',
    'settings.data.privacy.settings': 'Privacy Settings',
    'settings.data.usage.policy': 'Data Usage Policy',
    'settings.footer.version': 'KMRL Document Platform v2.1',
    'settings.footer.copyright': '© 2024 Kerala Metro Rail Limited',
    'settings.access.title': 'Role-Based Access Control',
    'settings.access.current.role': 'Current Role',
    'settings.access.role.document.manager': 'Document Manager',
    'settings.access.permissions': 'Permissions',
    'settings.access.permission.upload': 'Upload Documents',
    'settings.access.permission.notices': 'Create Notices',
    'settings.access.permission.reminders': 'Manage Reminders',
    'settings.access.permission.ai': 'Access AI Features',
    'settings.access.permission.department': 'Department Access',
    'settings.access.permission.admin': 'Admin Functions',
    'settings.access.status.allowed': 'Allowed',
    'settings.access.status.restricted': 'Restricted',
    'settings.access.departments.engineering.it': 'Engineering, IT',
    'settings.access.request.changes': 'Request Permission Changes',
    'settings.button.reset': 'Reset to Defaults',
    'settings.button.save': 'Save All Settings',
    
    // Settings Modal
    'modal.settings.title': 'KMRL Platform Settings',
    'modal.settings.ai.title': 'AI Features',
    'modal.settings.ai.auto.summary': 'Auto-generate summaries',
    'modal.settings.ai.auto.summary.description': 'Create AI summaries for new documents',
    'modal.settings.ai.smart.tagging': 'Smart tagging',
    'modal.settings.ai.smart.tagging.description': 'Auto-categorize documents',
    'modal.settings.ai.voice.search': 'Voice search',
    'modal.settings.ai.voice.search.description': 'Enable microphone for search',
    'modal.settings.ai.multi.language': 'Multi-language AI',
    'modal.settings.ai.multi.language.description': 'Process Malayalam documents',
    'modal.settings.audio.title': 'Audio Settings',
    'modal.settings.audio.playback.volume': 'Summary playback volume',
    'modal.settings.audio.mic.sensitivity': 'Microphone sensitivity',
    'modal.settings.privacy.title': 'Privacy & Security',
    'modal.settings.privacy.data.sharing': 'Data sharing for improvements',
    'modal.settings.privacy.data.sharing.description': 'Help improve AI features',
    'modal.settings.privacy.analytics': 'Usage analytics',
    'modal.settings.privacy.analytics.description': 'Anonymous usage statistics',
    'modal.settings.privacy.auto.backup': 'Automatic backup',
    'modal.settings.privacy.auto.backup.description': 'Secure cloud backup',
    'modal.settings.privacy.security.settings': 'Security Settings',
    'modal.settings.help.title': 'Help & Support',
    'modal.settings.help.tutorial.videos': 'Tutorial Videos',
    'modal.settings.help.user.guide': 'User Guide (PDF)',
    'modal.settings.help.contact.support': 'Contact IT Support',
    'modal.settings.help.report.issue': 'Report Issue',
    'modal.settings.button.save': 'Save Settings',
  ...
  ml: {
    ...
    'history.downloads.metro.expansion': 'മെട്രോ വിപുലീകരണ പദ്ധതി റിപ്പോർട്ട്',
    'history.downloads.safety.protocol': 'സുരക്ഷാ പ്രോട്ടോക്കോൾ മാർഗ്ഗനിർദ്ദേശങ്ങൾ',
    'history.downloads.budget.allocation': 'ബജറ്റ് വിഹിതം Q4 2024',
    'history.downloads.training.manual': 'ജീവനക്കാരുടെ പരിശീലന കൈപ്പുസ്തകം',
    'history.downloads.technical.specs': 'സാങ്കേതിക സവിശേഷതകൾ ഘട്ടം 2',
    'history.notices.system.maintenance': 'സിസ്റ്റം മെയിന്റനൻസ് ഷെഡ്യൂൾ',
    'history.notices.safety.protocol': 'പുതിയ സുരക്ഷാ പ്രോട്ടോക്കോൾ നടപ്പാക്കൽ',
    'history.notices.team.meeting': 'പ്രതിമാസ ടീം മീറ്റിംഗ്',
    'history.notices.budget.review': 'ബജറ്റ് അവലോകന മാർഗ്ഗനിർദ്ദേശങ്ങൾ',
    'history.notices.emergency.drill': 'എമർജൻസി ഡ്രിൽ ഷെഡ്യൂൾ',
    ...
    'history.authors.it.admin': 'ഐടി അഡ്മിൻ',
    ...
    'help.subtitle': 'ഉത്തരങ്ങൾ കണ്ടെത്തുക, ട്യൂട്ടോറിയലുകൾ കാണുക, ആവശ്യമായ സഹായം നേടുക',
    'help.quick.video.tutorials': 'വീഡിയോ ട്യൂട്ടോറിയലുകൾ',
    'help.quick.video.description': 'ഘട്ടം ഘട്ടമായുള്ള ഗൈഡുകൾ',
    'help.quick.faq': 'FAQ',
    'help.quick.faq.description': 'സാധാരണ ചോദ്യങ്ങൾ',
    'help.quick.contact': 'പിന്തുണയുമായി ബന്ധപ്പെടുക',
    'help.quick.contact.description': 'നേരിട്ട് സഹായം നേടുക',
    'help.tabs.tutorials': 'ട്യൂട്ടോറിയലുകൾ',
    'help.tabs.faq': 'FAQ',
    'help.tabs.troubleshooting': 'ട്രബിൾഷൂട്ടിംഗ്',
    'help.tabs.contact': 'ബന്ധപ്പെടുക',
    'help.button.watch.tutorial': 'ട്യൂട്ടോറിയൽ കാണുക',
    'help.search.faq.placeholder': 'FAQ തിരയുക...',
    'help.troubleshooting.title': 'സാധാരണ പ്രശ്നങ്ങളും പരിഹാരങ്ങളും',
    'help.contact.info.title': 'ബന്ധപ്പെടൽ വിവരങ്ങൾ',
    'help.contact.email.label': 'ഇമെയിൽ പിന്തുണ',
    'help.contact.phone.label': 'ഫോൺ പിന്തുണ',
    'help.contact.chat.label': 'ലൈവ് ചാറ്റ്',
    'help.contact.chat.hours': 'രാവിലെ 9 മണി മുതൽ വൈകുന്നേരം 6 മണി വരെ IST',
    'help.contact.form.title': 'സപ്പോർട്ട് അഭ്യർത്ഥന സമർപ്പിക്കുക',
    'help.contact.form.subject': 'വിഷയം',
    'help.contact.form.subject.placeholder': 'നിങ്ങളുടെ പ്രശ്നത്തിന്റെ ഹ്രസ്വ വിവരണം',
    'help.contact.form.category': 'വിഭാഗം',
    'help.contact.form.category.general': 'പൊതുവായ',
    'help.contact.form.category.technical': 'സാങ്കേതിക പ്രശ്നം',
    'help.contact.form.category.account': 'അക്കൗണ്ടും ആക്സസും',
    'help.contact.form.category.ai': 'AI സവിശേഷതകൾ',
    'help.contact.form.urgency': 'അടിയന്തിരത',
    'help.contact.form.urgency.normal': 'സാധാരണ',
    'help.contact.form.urgency.high': 'ഉയർന്നത്',
    'help.contact.form.urgency.urgent': 'അടിയന്തിരം',
    'help.contact.form.message': 'സന്ദേശം',
    'help.contact.form.message.placeholder': 'നിങ്ങളുടെ പ്രശ്നം വിശദമായി വിവരിക്കുക...',
    'help.contact.form.submit': 'സപ്പോർട്ട് അഭ്യർത്ഥന സമർപ്പിക്കുക',
    
    // Tutorials
    'help.tutorials.getting.started.title': 'KMRL ഡോക്യുമെന്റ് പ്ലാറ്റ്ഫോം ആരംഭിക്കുന്നു',
    'help.tutorials.getting.started.description': 'പ്രമാണങ്ങൾ അപ്‌ലോഡ് ചെയ്യുക, സംഘടിപ്പിക്കുക, തിരയുക എന്നിവയുടെ അടിസ്ഥാനകാര്യങ്ങൾ പഠിക്കുക',
    'help.tutorials.ai.features.title': 'AI സവിശേഷതകളുടെ അവലോകനം',
    'help.tutorials.ai.features.description': 'AI സംഗ്രഹങ്ങൾ, ഓട്ടോ-ടാഗിംഗ്, സ്മാർട്ട് റിമൈൻഡറുകൾ എങ്ങനെ പ്രവർത്തിക്കുന്നു എന്ന് കണ്ടെത്തുക',
    'help.tutorials.notifications.title': 'അറിയിപ്പുകളും ഓർമ്മപ്പെടുത്തലുകളും സജ്ജീകരിക്കുന്നു',
    'help.tutorials.notifications.description': 'നിങ്ങളുടെ അറിയിപ്പ് മുൻഗണനകൾ കോൺഫിഗർ ചെയ്യുകയും ഫലപ്രദമായ ഓർമ്മപ്പെടുത്തലുകൾ സൃഷ്ടിക്കുകയും ചെയ്യുക',
    'help.tutorials.collaboration.title': 'ടീം അംഗങ്ങളുമായി സഹകരിക്കുന്നു',
    'help.tutorials.collaboration.description': 'പ്രമാണങ്ങൾ പങ്കിടുക, അറിയിപ്പുകൾ സൃഷ്ടിക്കുക, വകുപ്പ് സഹപ്രവർത്തകരുമായി പ്രവർത്തിക്കുക',
    'help.tutorials.category.getting.started': 'ആരംഭിക്കുന്നു',
    'help.tutorials.category.ai.features': 'AI സവിശേഷതകൾ',
    'help.tutorials.category.notifications': 'അറിയിപ്പുകൾ',
    'help.tutorials.category.collaboration': 'സഹകരണം',
    
    // FAQ
    'help.faq.category.general': 'പൊതുവായ',
    'help.faq.category.ai.features': 'AI സവിശേഷതകൾ',
    'help.faq.category.security': 'സുരക്ഷ',
    'help.faq.general.upload.question': 'പ്ലാറ്റ്ഫോമിലേക്ക് ഒരു ഡോക്യുമെന്റ് എങ്ങനെ അപ്‌ലോഡ് ചെയ്യാം?',
    'help.faq.general.upload.answer': 'ഡാഷ്‌ബോർഡിലോ നാവിഗേഷൻ പാനലിലോ \'ഡോക്യുമെന്റ് അപ്‌ലോഡ് ചെയ്യുക\' ബട്ടണിൽ ക്ലിക്ക് ചെയ്തുകൊണ്ട് നിങ്ങൾക്ക് പ്രമാണങ്ങൾ അപ്‌ലോഡ് ചെയ്യാൻ കഴിയും. പിന്തുണയ്ക്കുന്ന ഫോർമാറ്റുകളിൽ PDF, DOCX, XLSX, ചിത്രങ്ങൾ എന്നിവ ഉൾപ്പെടുന്നു. AI യാന്ത്രികമായി നിങ്ങളുടെ ഡോക്യുമെന്റ് പ്രോസസ്സ് ചെയ്യുകയും വർഗ്ഗീകരിക്കുകയും ചെയ്യും.',
    'help.faq.general.formats.question': 'ഏതൊക്കെ ഫയൽ ഫോർമാറ്റുകൾ പിന്തുണയ്ക്കുന്നു?',
    'help.faq.general.formats.answer': 'ഞങ്ങൾ PDF, Microsoft Office ഡോക്യുമെന്റുകൾ (DOCX, XLSX, PPTX), ചിത്രങ്ങൾ (JPG, PNG), ടെക്സ്റ്റ് ഫയലുകൾ എന്നിവയെ പിന്തുണയ്ക്കുന്നു. പരമാവധി ഫയൽ വലുപ്പം ഒരു ഡോക്യുമെന്റിന് 50MB ആണ്.',
    'help.faq.general.ai.summary.question': 'AI സംഗ്രഹീകരണം എങ്ങനെ പ്രവർത്തിക്കുന്നു?',
    'help.faq.general.ai.summary.answer': 'ഞങ്ങളുടെ AI അപ്‌ലോഡ് ചെയ്ത ഡോക്യുമെന്റുകൾ യാന്ത്രികമായി വിശകലനം ചെയ്യുകയും പ്രധാന പോയിന്റുകൾ ഹൈലൈറ്റ് ചെയ്യുന്ന സംക്ഷിപ്ത സംഗ്രഹങ്ങൾ സൃഷ്ടിക്കുകയും ചെയ്യുന്നു. ഈ സംഗ്രഹങ്ങളുടെ ഓഡിയോ പതിപ്പുകൾ നിങ്ങൾക്ക് കേൾക്കാനും കഴിയും.',
    'help.faq.ai.tags.accuracy.question': 'AI-ജനറേറ്റഡ് ടാഗുകൾ എത്രത്തോളം കൃത്യമാണ്?',
    'help.faq.ai.tags.accuracy.answer': 'ഞങ്ങളുടെ AI ടാഗിംഗ് സിസ്റ്റത്തിന് 90%+ കൃത്യത നിരക്ക് ഉണ്ട്. ടാഗുകൾ ഡോക്യുമെന്റ് ഉള്ളടക്ക വിശകലനത്തെ അടിസ്ഥാനമാക്കിയുള്ളതാണ്, ആവശ്യമെങ്കിൽ സ്വമേധയാ എഡിറ്റ് ചെയ്യാം.',
    'help.faq.ai.disable.question': 'AI സവിശേഷതകൾ പ്രവർത്തനരഹിതമാക്കാൻ കഴിയുമോ?',
    'help.faq.ai.disable.answer': 'അതെ, AI സവിശേഷതകൾ വിഭാഗത്തിൽ AI സവിശേഷതകൾ ഓൺ/ഓഫ് ടോഗിൾ ചെയ്യാം. ഇതിൽ ഓട്ടോ-സംഗ്രഹങ്ങൾ, സ്മാർട്ട് ടാഗിംഗ്, റിമൈൻഡർ നിർദ്ദേശങ്ങൾ എന്നിവ ഉൾപ്പെടുന്നു.',
    'help.faq.security.data.question': 'എന്റെ ഡാറ്റ എത്രത്തോളം സുരക്ഷിതമാണ്?',
    'help.faq.security.data.answer': 'എല്ലാ ഡോക്യുമെന്റുകളും വിശ്രമത്തിലും ട്രാൻസിറ്റിലും എൻക്രിപ്റ്റ് ചെയ്തിരിക്കുന്നു. ഞങ്ങൾ വ്യവസായ-നിലവാരമുള്ള സുരക്ഷാ രീതികൾ പിന്തുടരുകയും ഡാറ്റ സംരക്ഷണ നിയന്ത്രണങ്ങൾ പാലിക്കുകയും ചെയ്യുന്നു.',
    'help.faq.security.access.question': 'എന്റെ ഡോക്യുമെന്റുകൾ ആർക്കൊക്കെ ആക്സസ് ചെയ്യാൻ കഴിയും?',
    'help.faq.security.access.answer': 'ഡോക്യുമെന്റ് ആക്സസ് റോൾ-അധിഷ്ഠിത അനുമതികളാൽ നിയന്ത്രിക്കപ്പെടുന്നു. നിങ്ങളുടെ സ്ഥാപനത്തിന്റെ ക്രമീകരണങ്ങളെ അടിസ്ഥാനമാക്കി അംഗീകൃത ടീം അംഗങ്ങൾക്കും വകുപ്പുകൾക്കും മാത്രമേ നിർദ്ദിഷ്ട ഡോക്യുമെന്റുകൾ കാണാൻ കഴിയൂ.',
    
    // Troubleshooting
    'help.troubleshooting.upload.issue': 'ഡോക്യുമെന്റുകൾ അപ്‌ലോഡ് ചെയ്യുന്നില്ല',
    'help.troubleshooting.upload.solution.1': 'ഫയൽ വലുപ്പം പരിശോധിക്കുക (50MB-ൽ താഴെയായിരിക്കണം)',
    'help.troubleshooting.upload.solution.2': 'ഫയൽ ഫോർമാറ്റ് പിന്തുണയ്ക്കുന്നുവെന്ന് സ്ഥിരീകരിക്കുക',
    'help.troubleshooting.upload.solution.3': 'ബ്രൗസർ കാഷെയും കുക്കികളും ക്ലിയർ ചെയ്യുക',
    'help.troubleshooting.upload.solution.4': 'മറ്റൊരു ബ്രൗസറിൽ നിന്ന് അപ്‌ലോഡ് ചെയ്യാൻ ശ്രമിക്കുക',
    'help.troubleshooting.upload.solution.5': 'പ്രശ്നം തുടരുകയാണെങ്കിൽ പിന്തുണയുമായി ബന്ധപ്പെടുക',
    'help.troubleshooting.ai.issue': 'AI സവിശേഷതകൾ പ്രവർത്തിക്കുന്നില്ല',
    'help.troubleshooting.ai.solution.1': 'ക്രമീകരണങ്ങളിൽ AI സവിശേഷതകൾ പ്രവർത്തനക്ഷമമാക്കിയിട്ടുണ്ടെന്ന് ഉറപ്പാക്കുക',
    'help.troubleshooting.ai.solution.2': 'ഡോക്യുമെന്റ് ഫോർമാറ്റ് പൊരുത്തം പരിശോധിക്കുക',
    'help.troubleshooting.ai.solution.3': 'പ്രോസസ്സിംഗ് പൂർത്തിയാകുന്നതുവരെ കാത്തിരിക്കുക (1-2 മിനിറ്റ് എടുത്തേക്കാം)',
    'help.troubleshooting.ai.solution.4': 'പേജ് റിഫ്രഷ് ചെയ്ത് വീണ്ടും ശ്രമിക്കുക',
    'help.troubleshooting.ai.solution.5': 'സാങ്കേതിക പിന്തുണയുമായി ബന്ധപ്പെടുക',
    'help.troubleshooting.access.issue': 'ചില ഡോക്യുമെന്റുകൾ ആക്സസ് ചെയ്യാൻ കഴിയുന്നില്ല',
    'help.troubleshooting.access.solution.1': 'നിങ്ങൾക്ക് ശരിയായ അനുമതികൾ ഉണ്ടെന്ന് സ്ഥിരീകരിക്കുക',
    'help.troubleshooting.access.solution.2': 'ഡോക്യുമെന്റ് നീക്കുകയോ ഇല്ലാതാക്കുകയോ ചെയ്തിട്ടുണ്ടോ എന്ന് പരിശോധിക്കുക',
    'help.troubleshooting.access.solution.3': 'ഡോക്യുമെന്റ് ഉടമയുമായോ അഡ്മിനിസ്ട്രേറ്ററുമായോ ബന്ധപ്പെടുക',
    'help.troubleshooting.access.solution.4': 'നിങ്ങൾ ശരിയായ അക്കൗണ്ടിലേക്ക് ലോഗിൻ ചെയ്തിട്ടുണ്ടെന്ന് ഉറപ്പാക്കുക',
    'help.troubleshooting.access.solution.5': 'ആക്സസ് നിയന്ത്രണ ക്രമീകരണങ്ങൾ അവലോകനം ചെയ്യുക',

    // Settings Section
    'settings.title': 'ക്രമീകരണങ്ങൾ',
    'settings.subtitle': 'നിങ്ങളുടെ KMRL പ്ലാറ്റ്ഫോം അനുഭവം ഇഷ്ടാനുസൃതമാക്കുക',
    'settings.tabs.preferences': 'മുൻഗണനകൾ',
    'settings.tabs.security': 'സുരക്ഷ',
    'settings.tabs.access': 'ആക്സസ് നിയന്ത്രണം',
    'settings.appearance.title': 'കാഴ്ച',
    'settings.appearance.dark.mode': 'ഡാർക്ക് മോഡ്',
    'settings.appearance.dark.mode.description': 'ലൈറ്റ്, ഡാർക്ക് തീമുകൾ തമ്മിൽ മാറുക',
    'settings.appearance.compact.view': 'കോംപാക്ട് വ്യൂ',
    'settings.appearance.compact.view.description': 'കുറഞ്ഞ സ്ഥലത്ത് കൂടുതൽ ഉള്ളടക്കം കാണിക്കുക',
    'settings.appearance.language': 'ഭാഷ',
    'settings.notifications.title': 'അറിയിപ്പുകൾ',
    'settings.notifications.documents': 'ഡോക്യുമെന്റ് അപ്‌ലോഡുകൾ',
    'settings.notifications.reminders': 'ഓർമ്മപ്പെടുത്തലുകൾ',
    'settings.notifications.notices': 'പ്രധാന അറിയിപ്പുകൾ',
    'settings.notifications.ai.processing': 'AI പ്രോസസ്സിംഗ്',
    'settings.preferences.title': 'പൊതുവായ മുൻഗണനകൾ',
    'settings.preferences.auto.save': 'ഡ്രാഫ്റ്റുകൾ സ്വയമേവ സംരക്ഷിക്കുക',
    'settings.preferences.auto.save.description': 'പുരോഗമിക്കുന്ന ജോലി സ്വയമേവ സംരക്ഷിക്കുക',
    'settings.preferences.show.tips': 'നുറുങ്ങുകൾ കാണിക്കുക',
    'settings.preferences.show.tips.description': 'സഹായകരമായ നുറുങ്ങുകളും മാർഗനിർദേശങ്ങളും പ്രദർശിപ്പിക്കുക',
    'settings.preferences.auto.logout': 'സ്വയമേവ ലോഗൗട്ട് (മിനിറ്റുകൾ)',
    'settings.data.privacy.title': 'ഡാറ്റയും സ്വകാര്യതയും',
    'settings.data.export': 'എന്റെ ഡാറ്റ എക്സ്പോർട്ട് ചെയ്യുക',
    'settings.data.privacy.settings': 'സ്വകാര്യത ക്രമീകരണങ്ങൾ',
    'settings.data.usage.policy': 'ഡാറ്റ ഉപയോഗ നയം',
    'settings.footer.version': 'KMRL ഡോക്യുമെന്റ് പ്ലാറ്റ്ഫോം v2.1',
    'settings.footer.copyright': '© 2024 കേരള മെട്രോ റെയിൽ ലിമിറ്റഡ്',
    'settings.access.title': 'റോൾ അധിഷ്ഠിത ആക്സസ് നിയന്ത്രണം',
    'settings.access.current.role': 'നിലവിലെ റോൾ',
    'settings.access.role.document.manager': 'ഡോക്യുമെന്റ് മാനേജർ',
    'settings.access.permissions': 'അനുമതികൾ',
    'settings.access.permission.upload': 'ഡോക്യുമെന്റുകൾ അപ്‌ലോഡ് ചെയ്യുക',
    'settings.access.permission.notices': 'അറിയിപ്പുകൾ സൃഷ്ടിക്കുക',
    'settings.access.permission.reminders': 'ഓർമ്മപ്പെടുത്തലുകൾ മാനേജ് ചെയ്യുക',
    'settings.access.permission.ai': 'AI സവിശേഷതകൾ ആക്സസ് ചെയ്യുക',
    'settings.access.permission.department': 'വകുപ്പ് ആക്സസ്',
    'settings.access.permission.admin': 'അഡ്മിൻ ഫംഗ്ഷനുകൾ',
    'settings.access.status.allowed': 'അനുവദിച്ചത്',
    'settings.access.status.restricted': 'നിയന്ത്രിച്ചത്',
    'settings.access.departments.engineering.it': 'എഞ്ചിനീയറിംഗ്, ഐടി',
    'settings.access.request.changes': 'അനുമതി മാറ്റങ്ങൾ അഭ്യർത്ഥിക്കുക',
    'settings.button.reset': 'ഡിഫോൾട്ടുകളിലേക്ക് പുനഃസജ്ജമാക്കുക',
    'settings.button.save': 'എല്ലാ ക്രമീകരണങ്ങളും സംരക്ഷിക്കുക',
    
    // Settings Modal
    'modal.settings.title': 'KMRL പ്ലാറ്റ്ഫോം ക്രമീകരണങ്ങൾ',
    'modal.settings.ai.title': 'AI സവിശേഷതകൾ',
    'modal.settings.ai.auto.summary': 'സംഗ്രഹങ്ങൾ സ്വയമേവ സൃഷ്ടിക്കുക',
    'modal.settings.ai.auto.summary.description': 'പുതിയ ഡോക്യുമെന്റുകൾക്കായി AI സംഗ്രഹങ്ങൾ സൃഷ്ടിക്കുക',
    'modal.settings.ai.smart.tagging': 'സ്മാർട്ട് ടാഗിംഗ്',
    'modal.settings.ai.smart.tagging.description': 'ഡോക്യുമെന്റുകൾ സ്വയമേവ വർഗ്ഗീകരിക്കുക',
    'modal.settings.ai.voice.search': 'വോയ്സ് സെർച്ച്',
    'modal.settings.ai.voice.search.description': 'തിരയലിനായി മൈക്രോഫോൺ പ്രവർത്തനക്ഷമമാക്കുക',
    'modal.settings.ai.multi.language': 'മൾട്ടി-ലാംഗ്വേജ് AI',
    'modal.settings.ai.multi.language.description': 'മലയാളം ഡോക്യുമെന്റുകൾ പ്രോസസ്സ് ചെയ്യുക',
    'modal.settings.audio.title': 'ഓഡിയോ ക്രമീകരണങ്ങൾ',
    'modal.settings.audio.playback.volume': 'സംഗ്രഹ പ്ലേബാക്ക് വോളിയം',
    'modal.settings.audio.mic.sensitivity': 'മൈക്രോഫോൺ സെൻസിറ്റിവിറ്റി',
    'modal.settings.privacy.title': 'സ്വകാര്യതയും സുരക്ഷയും',
    'modal.settings.privacy.data.sharing': 'മെച്ചപ്പെടുത്തലുകൾക്കായി ഡാറ്റ പങ്കിടൽ',
    'modal.settings.privacy.data.sharing.description': 'AI സവിശേഷതകൾ മെച്ചപ്പെടുത്താൻ സഹായിക്കുക',
    'modal.settings.privacy.analytics': 'ഉപയോഗ അനലിറ്റിക്സ്',
    'modal.settings.privacy.analytics.description': 'അജ്ഞാത ഉപയോഗ സ്ഥിതിവിവരക്കണക്കുകൾ',
    'modal.settings.privacy.auto.backup': 'സ്വയമേവയുള്ള ബാക്കപ്പ്',
    'modal.settings.privacy.auto.backup.description': 'സുരക്ഷിത ക്ലൗഡ് ബാക്കപ്പ്',
    'modal.settings.privacy.security.settings': 'സുരക്ഷാ ക്രമീകരണങ്ങൾ',
    'modal.settings.help.title': 'സഹായവും പിന്തുണയും',
    'modal.settings.help.tutorial.videos': 'ട്യൂട്ടോറിയൽ വീഡിയോകൾ',
    'modal.settings.help.user.guide': 'ഉപയോക്തൃ ഗൈഡ് (PDF)',
    'modal.settings.help.contact.support': 'ഐടി പിന്തുണയുമായി ബന്ധപ്പെടുക',
    'modal.settings.help.report.issue': 'പ്രശ്നം റിപ്പോർട്ട് ചെയ്യുക',
    'modal.settings.button.save': 'ക്രമീകരണങ്ങൾ സംരക്ഷിക്കുക',
