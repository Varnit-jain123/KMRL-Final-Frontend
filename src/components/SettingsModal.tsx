        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
          ...
          <Card className="kmrl-card">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div>
                    <span className="text-sm font-medium">{t('modal.settings.ai.auto.summary')}</span>
                    <p className="text-xs text-muted-foreground">{t('modal.settings.ai.auto.summary.description')}</p>
                  </div>
                  <Switch
                    checked={aiSettings.autoSummary}
                    onCheckedChange={(checked) => 
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <span className="text-sm font-medium">{t('modal.settings.ai.smart.tagging')}</span>
                    <p className="text-xs text-muted-foreground">{t('modal.settings.ai.smart.tagging.description')}</p>
                  </div>
                  <Switch
                    checked={aiSettings.autoTagging}
                    onCheckedChange={(checked) => 
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <span className="text-sm font-medium">{t('modal.settings.ai.voice.search')}</span>
                    <p className="text-xs text-muted-foreground">{t('modal.settings.ai.voice.search.description')}</p>
                  </div>
                  <Switch
                    checked={aiSettings.voiceSearch}
                    onCheckedChange={(checked) => 
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <span className="text-sm font-medium">{t('modal.settings.ai.multi.language')}</span>
                    <p className="text-xs text-muted-foreground">{t('modal.settings.ai.multi.language.description')}</p>
                  </div>
                  <Switch
                    checked={aiSettings.multiLanguage}
                    onCheckedChange={(checked) => 
          ...
          <Card className="kmrl-card">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-4">
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium">{t('modal.settings.audio.playback.volume')}</span>
                    <Badge variant="secondary">{audioSettings.summaryPlayback[0]}%</Badge>
                  </div>
                  <Slider
                    value={audioSettings.summaryPlayback}
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium">{t('modal.settings.audio.mic.sensitivity')}</span>
                    <Badge variant="secondary">{audioSettings.microphoneSensitivity[0]}%</Badge>
                  </div>
                  <Slider
                    value={audioSettings.microphoneSensitivity}
          ...
          <Card className="kmrl-card">
            <CardHeader>
              <CardTitle className="text-lg flex items-center">
                <Shield className="mr-2 h-5 w-5" />
                {t('modal.settings.privacy.title')}
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div>
                    <span className="text-sm font-medium">{t('modal.settings.privacy.data.sharing')}</span>
                    <p className="text-xs text-muted-foreground">{t('modal.settings.privacy.data.sharing.description')}</p>
                  </div>
                  <Switch
                    checked={privacy.dataSharing}
                    onCheckedChange={(checked) => 
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <span className="text-sm font-medium">{t('modal.settings.privacy.analytics')}</span>
                    <p className="text-xs text-muted-foreground">{t('modal.settings.privacy.analytics.description')}</p>
                  </div>
                  <Switch
                    checked={privacy.analyticsOptIn}
                    onCheckedChange={(checked) => 
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <span className="text-sm font-medium">{t('modal.settings.privacy.auto.backup')}</span>
                    <p className="text-xs text-muted-foreground">{t('modal.settings.privacy.auto.backup.description')}</p>
                  </div>
                  <Switch
                    checked={privacy.autoBackup}
                    onCheckedChange={(checked) => 
              ...
              <div className="space-y-2">
                ...
                <Button variant="outline" size="sm" className="w-full">
                  <Lock className="mr-2 h-4 w-4" />
                  {t('modal.settings.privacy.security.settings')}
                </Button>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="kmrl-card">
            <CardHeader>
              <CardTitle className="text-lg">{t('modal.settings.help.title')}</CardTitle>
            </CardHeader>
            <CardContent className="space-y-3">
              <Button variant="outline" size="sm" className="w-full justify-start">
                {t('modal.settings.help.tutorial.videos')}
              </Button>
              <Button variant="outline" size="sm" className="w-full justify-start">
                {t('modal.settings.help.user.guide')}
              </Button>
              <Button variant="outline" size="sm" className="w-full justify-start">
                {t('modal.settings.help.contact.support')}
              </Button>
              <Button variant="outline" size="sm" className="w-full justify-start">
                {t('modal.settings.help.report.issue')}
              </Button>
